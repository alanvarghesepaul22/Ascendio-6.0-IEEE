    ...
    <div className="w-full bg-black  bg-grid-small-white/[0.2]  relative flex items-center justify-center p-40">
      ...
      <div className="container mx-auto px-4 py-8 z-50">
        ...
        <div className="mb-4">
          ...
          <p className="mb-2">
            <strong>Limitation of Liability:</strong> Ascendio and its
            ...
            or use, our website; (ii) any conduct or content of any third party
            on our website; or (iii) unauthorized access, use, or alteration of
          ...
          <p className="mb-2">
            <strong>Disclaimer of Warranties:</strong> Our website is provided
            ...
            the use of our website will be accurate or reliable; or (iv) the
        ...
        <div className="mb-4">
          <h2 className="text-2xl font-semibold mb-2">Rules of Conduct</h2>
          <ul className="list-disc pl-8">
            ...
            <li>
              Engage in any conduct that is offensive, threatening, or harmful
              to others; or
            </li>
            <li>
        ...
        <div className="mb-4">
          <h2 className="text-2xl font-semibold mb-2">User Restrictions</h2>
          <p>
        ...
        <div className="mb-4">
          ...
          <p>
            ...
            time, so please review them frequently. If we make material changes
            to these terms and conditions, we will notify you here, by email, or
            by means of a notice on our website prior to the change becoming
            effective.
          </p>
        </div>
