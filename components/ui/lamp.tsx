...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-full flex-col items-center justify-center bg-neutral-950 w-full pt-5",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate mt-32">
        <motion.div
        ...
        <div className="absolute top-1/2 h-8 w-full translate-y-12 scale-x-150 bg-neutral-950 blur-2xl"></div>
        <div className="absolute top-1/2 z-50 h-8 w-full bg-transparent opacity-10 backdrop-blur-md"></div>
      ...
      <div className="w-full relative z-50 flex -translate-y-40 flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
