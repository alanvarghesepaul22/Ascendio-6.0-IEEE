    ...
    <div className="max-w-xl w-full mx-auto rounded-none md:rounded-2xl mt-24  md:p-8 shadow-input bg-white dark:bg-black">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input id="email" placeholder="ticketascendio@gmail.com" type="email" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
          <Label htmlFor="mobnum">Mobile No. (Preferebly Whatsapp) </Label>
          <Input id="mobnum" type="text" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input id="ieeeid" type="number" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
          <Label htmlFor="wrksp">Workshop Preference</Label>
          <Input id="wrksp" placeholder="dropdown 2 item" type="text" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
          <Label htmlFor="food">Food Preference</Label>
          <Input id="food" type="text" placeholder="dropdown 2 item vegnonveg"/>
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
          <Label htmlFor="tshirt">T-Shirt Size</Label>
          <Input id="tshirt" type="text" placeholder="dropdown 4 item sm md lg xl xxl" />
        </LabelInputContainer>
